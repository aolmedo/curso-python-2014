...
class ContactWindow(wx.Frame):
    ...
    def InitUI(self):
        ...
        #text nombre
        firstname_txt = wx.TextCtrl(self.panel)
        ...
        #text apellido
        lastname_txt = wx.TextCtrl(self.panel)
        ...
        #email_txt
        email_txt = wx.TextCtrl(self.panel)
        ...
        #phone_txt
        phone_txt = wx.TextCtrl(self.panel)
